...
const category = categories.find(c => c.id === 'wedding-day')
const base = `${import.meta.env.BASE_URL}gallery/wedding-day/`
  ...
  return (
    <div className="gp">
      ...
      <div className="gp__nav">
        <Link to="/gallery/pre-wedding" className="gp__nav-item">
          <span className="gp__nav-dot" />Ảnh đám hỏi
        </Link>
        <Link to="/gallery/wedding-day" className="gp__nav-item gp__nav-item--active">
